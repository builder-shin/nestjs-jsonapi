...
export declare class ArticleController extends JsonApiCrudController {
    ...
    publish(id: string): Promise<import("@builder-shin/nestjs-jsonapi").JsonApiDocument<any>>;
    archive(id: string): Promise<import("@builder-shin/nestjs-jsonapi").JsonApiDocument<any>>;
    protected logRequest(): Promise<void>;
    protected loadArticle(): Promise<void>;
    protected notifySubscribers(): Promise<void>;
